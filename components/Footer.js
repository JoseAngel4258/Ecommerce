...
export default function Footer() {
  ...
  return (
    <div className="canvas">
      <div className="w-full h-[260px] flex items-center justify-center bg-slate-500 backdrop-filter backdrop-blur-md bg-opacity-40 shadow-lg">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          <div className="w-full text-7xl font-bold"></div>
          <div className="flex -mt-9 flex-col md:flex-row md:justify-between"></div>
          <div className="flex flex-col">
            <div className="mt-24 mb-12">
              <div className="flex flex-row justify-between items-center align-text-bottom ">
                <div className="text-3xl ">E-commerce</div>

                <a className="hidden md:block cursor-pointer  hover:text-cyan-500 uppercase">
                  About
                </a>
                <a className="hidden md:block cursor-pointer  hover:text-cyan-500 uppercase">
                  Services
            ...
            <hr className="mb-12" />
            <p className="w-full text-center mb-12">Copyright © 2023 Punpun</p>
          </div>
        </div>
      </div>
    </div>
